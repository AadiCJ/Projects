    ...
    SidePanel(){
        ...
        clear.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                Frame.clearAll();//this static method calls the Panel.clearAll() method(non static)
            }
        });
        add(clear);
        ...
        fill.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                Frame.fillBack();//a button that fills the background with the selected colour.
            }
        });
        add(fill);
        ...
        brush.addChangeListener(new ChangeListener(){
            public void stateChanged(ChangeEvent e){
                Frame.setBrushSize(brush.getValue());//setting brush size.
            }
        });
