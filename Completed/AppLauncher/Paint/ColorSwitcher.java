...
public class ColorSwitcher extends JFrame{
    ...
    ColorSwitcher(){
        ...
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);//DISPOSE_ON_CLOSE is used so that the paint application is not closed
        ...
        add(b);
        submit.addActionListener(new ActionListener(){//action listener for the submit button
            public void actionPerformed(ActionEvent e){
                PaintFrame.setColor(new int[]{R, G, B}, "");//calls the static method setColor
            }
        });
